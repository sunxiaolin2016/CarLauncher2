 ...
 */
package com.demo.launcher.graphics;

import static com.demo.launcher.Utilities.getDevicePrefs;
...
import com.demo.launcher.util.LooperExecutor;
...
public class IconShapeOverride {
   ...
   // private static final String ICON_SQUIRCLE = "M50,0 C10,0 0,10 0,50 0,90 10,100 50,100 90,100 100,90 100,50 100,10 90,0 50,0 Z";
    private static final String ICON_SQUIRCLE = "m79.69999,99.49999l-59.39999,0c-10.93125,0 -19.8,-8.86875 -19.8,-19.8l0,-59.39999c0,-10.93125 8.86875,-19.8 19.8,-19.8l59.39999,0c10.93125,0 19.8,8.86875 19.8,19.8l0,59.39999c0,10.93125 -8.86875,19.8 -19.8,19.8z";
    ...
    //by hxq 1028   , now we supported the sqcirel icon style ,because it is beautiful.
...
//        return getConfigResId() != 0;
   ...
   //    by hxq change iocn 1028 iocn shape
    private static String getAppliedValue(Context context) {
         return getDevicePrefs(context).getString(KEY_PREFERENCE, ICON_SQUIRCLE);
