...
public class ShortcutAndWidgetContainer extends ViewGroup {
      static   final String TAGD = "ShortcutAndWidgetContainer";
    ...
    public void setCellDimensions(int cellWidth, int cellHeight, int countX, int countY) {
        if(LOGD){
            Log.d(TAGD, "=== >setCellDimensions   cellWidth [" + cellWidth + "] ,cellHeight [ " +cellHeight + "]");
            Log.d(TAGD, "=== >setCellDimensions   countX [" + countX + "] ,countY [ " +countY + "]");
        }
