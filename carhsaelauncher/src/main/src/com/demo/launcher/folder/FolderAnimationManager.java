...
import static com.demo.launcher.BubbleTextView.TEXT_ALPHA_PROPERTY;
...
import com.demo.launcher.ShortcutAndWidgetContainer;
import com.demo.launcher.Utilities;
import com.demo.launcher.anim.PropertyResetListener;
import com.demo.launcher.anim.RoundedRectRevealOutlineProvider;
...
public class FolderAnimationManager {
    ...
    public FolderAnimationManager(Folder folder, boolean isOpening) {
        Log.i(TAG, "==FolderAnimationManager=============isOpening [ " + isOpening+"]");
    ...
    public AnimatorSet getAnimator() {
        ...
        int initialX = folderIconPos.left + mPreviewBackground.getOffsetX() - paddingOffsetX
                - previewItemOffsetX + 22 ;
        int initialY = folderIconPos.top + mPreviewBackground.getOffsetY() - paddingOffsetY+ 22  ;
        final float xDistance = initialX - lp.x;
        final float yDistance = initialY - lp.y;

        // Set up the Folder background.
          int finalColor =  Themes.getAttrColor(mContext, android.R.attr.colorPrimary);
          int initialColor =
      ...
      //  addPreviewItemAnimators(a, initialScale / scaleRelativeToDragLayer, previewItemOffsetX + radiusDiff, radiusDiff);
        return a;
    }
