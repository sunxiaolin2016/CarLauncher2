...
public class PreviewBackground {
    ...
    private static final String TAG = "PreviewBackground";
    ...
    /* 20180924 modify begin hxq  to rect*/
    private void drawCircle(Canvas canvas,float deltaRadius) {
      ...
      //           radius - deltaRadius, mPaint);
        ...
        canvas.drawRoundRect(0 + getOffsetX(), 0 + getOffsetY()+16, radius * 2 + getOffsetX(),
                radius * 2 + getOffsetY()+16, 20, 20, mPaint);
        if(DEBUG){
            Log.i(TAG, "drawCircle 2222222==[" + getOffsetX()+"], getOffsetY()[" + getOffsetY() + "],radius * 2 + getOffsetX["+(radius * 2 + getOffsetX()) +"],[" + (radius * 2 + getOffsetY()));
        }
    ...
    public Path getClipPath() {
        ...
        float radius = getScaledRadius();
        if(DEBUG){
            Log.d(TAG, "getClipPath===========>");
        }
       // mPath.addCircle(r + getOffsetX(), r + getOffsetY(), r, Path.Direction.CW);
        mPath.addRoundRect( 0 + getOffsetX(), 0 + getOffsetY()+16, radius * 2 + getOffsetX(),
                radius * 2 + getOffsetY()+16, 20, 20,  Path.Direction.CW);
        return mPath;
    }
