...
import static com.demo.launcher.LauncherAnimUtils.OVERVIEW_TRANSITION_MS;
import static com.demo.launcher.LauncherAnimUtils.SPRING_LOADED_EXIT_DELAY;
import static com.demo.launcher.LauncherAnimUtils.SPRING_LOADED_TRANSITION_MS;
import static com.demo.launcher.LauncherState.ALL_APPS;
import static com.demo.launcher.LauncherState.NORMAL;
import static com.demo.launcher.LauncherState.SPRING_LOADED;
import static com.demo.launcher.dragndrop.DragLayer.ALPHA_INDEX_OVERLAY;
...
import com.demo.launcher.Launcher.LauncherOverlay;
import com.demo.launcher.LauncherAppWidgetHost.ProviderChangedListener;
import com.demo.launcher.LauncherStateManager.AnimationConfig;
import com.demo.launcher.accessibility.AccessibleDragListenerAdapter;
import com.demo.launcher.accessibility.WorkspaceAccessibilityHelper;
import com.demo.launcher.anim.AnimatorSetBuilder;
import com.demo.launcher.anim.Interpolators;
import com.demo.launcher.badge.FolderBadgeInfo;
import com.demo.launcher.compat.AppWidgetManagerCompat;
import com.demo.launcher.compat.LauncherAppsCompat;
...
import com.demo.launcher.dragndrop.DragOptions;
import com.demo.launcher.dragndrop.DragView;
import com.demo.launcher.dragndrop.SpringLoadedDragController;
import com.demo.launcher.folder.Folder;
import com.demo.launcher.folder.FolderIcon;
import com.demo.launcher.folder.PreviewBackground;
import com.demo.launcher.graphics.DragPreviewProvider;
import com.demo.launcher.graphics.PreloadIconDrawable;
import com.demo.launcher.pageindicators.WorkspacePageIndicator;
import com.demo.launcher.plug.ExtraIndicatorListener;
import com.demo.launcher.popup.PopupContainerWithArrow;
import com.demo.launcher.shortcuts.ShortcutDragPreviewProvider;
import com.demo.launcher.touch.ItemLongClickListener;
import com.demo.launcher.touch.WorkspaceTouchListener;
...
import com.demo.launcher.util.LongArrayMap;
import com.demo.launcher.util.PackageUserKey;
import com.demo.launcher.util.Thunk;
import com.demo.launcher.util.WallpaperOffsetInterpolator;
...
public class Workspace extends PagedView<WorkspacePageIndicator>
    ...
    private ExtraIndicatorListener extraIndicatorListener;
    ...
    public void onDragStart(DropTarget.DragObject dragObject, DragOptions options) {
        ...
        // Log.d(TAG , "goToState=============>SPRING_LOADED");
...
//        if (extraIndicatorListener != null) {
//            if(hasExtraEmptyScreen()){
//                extraIndicatorListener.notifyPageCountChanged(getChildCount()-1);
//            }else{
//                extraIndicatorListener.notifyPageCountChanged(getChildCount());
//            }
//        }
    ...
    public void onViewRemoved(View child) {
        ...
        extraIndicatorListener.notifyPageCountChanged(-1, getChildCount());
    }
    ...
    public CellLayout insertNewWorkspaceScreen(long screenId, int insertIndex) {
        ...
        //hxq weather
        if (screenId == 0) {
            newScreen.enableTopPartImageBackGround(VISIBLE);
            newScreen.addXzImageView();
            newScreen.enableXzImageBackGround(VISIBLE);
            newScreen.refreshTopPartImageBackGround(R.drawable.img_weather_rain_bg);
        } else {
            newScreen.enableTopPartImageBackGround(VISIBLE);
        }
        Log.i(TAG, "insertNewWorkspaceScreen new CellLayout index [" + screenId + "]");

//        ViewGroup.LayoutParams params = newScreen.getLayoutParams();
...
//        marginParams.setMargins(30,30,30,30);
        ...
        //int paddingTop = getResources().getDimensionPixelSize(R.dimen.celllayout_pading_top);
        //  newScreen.setPadding(paddingLeftRight, paddingTop, paddingLeftRight, paddingBottom);
    ...
    public long commitExtraEmptyScreen() {
        ...
        Log.i(TAG, "============add  real celllayout to DB  === newId[ " + newId + "]");
        if(extraIndicatorListener != null){
            extraIndicatorListener.notifyPageCountChanged(1, getPageCount());
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        boolean isIngercept = super.onInterceptTouchEvent(ev);
        return isIngercept;
    }
...
//        hxq
    ...
    protected void notifyPageSwitchListener(int prevPage) {
        ...
        if (extraIndicatorListener != null) {
            extraIndicatorListener.notifyPageSwitchListener(prevPage, mCurrentPage);
        }

    }

    public void setExtraIndicatorListener(ExtraIndicatorListener extraIndicatorListener) {
        this.extraIndicatorListener = extraIndicatorListener;
    }
    ...
    public DragView beginDragShared(View child, DragSource source, ItemInfo dragObject,
        ...
        // add by hxq . just the normal app can uninstall
        if (child instanceof BubbleTextView && !dragOptions.isAccessibleDrag) {
            ...
            if (intent != null) {
                LauncherActivityInfo info = LauncherAppsCompat.getInstance(mLauncher)
                        .resolveActivity(intent, itemInfo.user);
