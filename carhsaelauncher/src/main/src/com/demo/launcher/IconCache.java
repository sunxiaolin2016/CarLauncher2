...
import com.demo.launcher.config.DbVersion;
import com.demo.launcher.graphics.BitmapInfo;
import com.demo.launcher.graphics.BitmapRenderer;
import com.demo.launcher.graphics.LauncherIcons;
import com.demo.launcher.model.PackageItemInfo;
...
import com.demo.launcher.util.SQLiteCacheHelper;
...
public class IconCache {
    ...
    protected CacheEntry cacheLocked(
       ...
       if(DEBUG){
           Log.i(TAG, "cacheLocked ===== usePackageIcon [" + usePackageIcon+ "] componentName ["+ componentName+"]");
       }
    ...
    private static final class IconDB extends SQLiteCacheHelper {
        private final static int RELEASE_VERSION = DbVersion.ICON_DB_VER;
