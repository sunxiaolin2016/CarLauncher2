...
import com.demo.launcher.CellLayout.ContainerType;
import com.demo.launcher.badge.BadgeRenderer;
import com.demo.launcher.graphics.IconNormalizer;
...
//            Log.i(TAG, "222222===updateAvailableDimensions , usedHeight > maxHeight[ "+ usedHeight +  "]>[" +maxHeight);
...
//        }
    ...
    private void updateIconSize(float scale, Resources res, DisplayMetrics dm) {
        ...
        // Folder icon
        int fakeIconSizePx = 122;
        folderIconSizePx = 122;//IconNormalizer.getNormalizedCircleSize(fakeIconSizePx);
        folderIconOffsetYPx = 0;//(fakeIconSizePx - folderIconSizePx) / 2;
    }
