...
public abstract class ArrowPopup extends AbstractFloatingView {
    ...
    protected void reorderAndShow(int viewsToFlip) {
        Log.i(TAG, "reorderAndShow START");
        ...
        //hxq disable it because GL ERROR 5022
//        if (reverseOrder) {
...
//        onInflationComplete(reverseOrder);
      ...
      //  mLauncher.getDragLayer().addView(mArrow); // hxq
      ...
      //      mArrow.setX(getX() + arrowCenterOffset - halfArrowWidth);
       ...
       //     mArrow.setX(getX() + getMeasuredWidth() - arrowCenterOffset - halfArrowWidth);
        ...
        Log.i(TAG , "1----mArrow X [" + mArrow.getX()+ "]Y[" + mArrow.getY()+"]");
...
//            mArrow.setElevation(getElevation());
       ...
       // Log.i(TAG , "20------mArrow X [" + mArrow.getX()+ "]Y[" + mArrow.getY()+"]");
        animateOpen();
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (Gravity.isHorizontal(mGravity)) {
            ...
            mArrow.setVisibility(INVISIBLE);
            Log.i(TAG, "11------onLayout :" + getX());
        }
        if (Gravity.isVertical(mGravity)) {
            //setY(dragLayer.getHeight() / 2 - getMeasuredHeight() / 2);

            Log.i(TAG, "222------onLayout :" + getX());
        }
    }

    private void animateOpen() {
         setVisibility(View.VISIBLE);
        Log.i(TAG, "animateOpen======================");
