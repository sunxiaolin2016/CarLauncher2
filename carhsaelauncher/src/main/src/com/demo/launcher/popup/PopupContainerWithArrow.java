...
package com.demo.launcher.popup;

import static com.demo.launcher.notification.NotificationMainView.NOTIFICATION_ITEM_INFO;
import static com.demo.launcher.popup.PopupPopulator.MAX_SHORTCUTS;
import static com.demo.launcher.popup.PopupPopulator.MAX_SHORTCUTS_IF_NOTIFICATIONS;
import static com.demo.launcher.userevent.nano.LauncherLogProto.ContainerType;
import static com.demo.launcher.userevent.nano.LauncherLogProto.ItemType;
import static com.demo.launcher.userevent.nano.LauncherLogProto.Target;
...
import com.demo.launcher.logging.LoggerUtils;
import com.demo.launcher.notification.NotificationInfo;
import com.demo.launcher.notification.NotificationItemView;
import com.demo.launcher.notification.NotificationKeyData;
import com.demo.launcher.shortcuts.DeepShortcutManager;
import com.demo.launcher.shortcuts.DeepShortcutView;
...
public class PopupContainerWithArrow extends ArrowPopup implements DragSource,
    ...
    private void populateAndShow(final BubbleTextView originalIcon, final List<String> shortcutIds,
        ...
        // Add views
        // never add view  for notificaiton  , hxq
...
//        }
        ...
        initializeUninstallShortcut(R.layout.system_shortcut_uninstall, this);
    ...
    private void initializeUninstallShortcut(int resId, ViewGroup container) {
        View view = inflateAndAdd(resId, container);
        view.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                animateClose();
                ItemInfo info =  (ItemInfo)mOriginalIcon.getTag();
