...
package com.demo.launcher.model;

import static com.demo.launcher.ItemInfoWithIcon.FLAG_DISABLED_LOCKED_USER;
import static com.demo.launcher.ItemInfoWithIcon.FLAG_DISABLED_SAFEMODE;
import static com.demo.launcher.ItemInfoWithIcon.FLAG_DISABLED_SUSPENDED;
import static com.demo.launcher.folder.ClippedFolderIconLayoutRule.MAX_NUM_ITEMS_IN_PREVIEW;
import static com.demo.launcher.model.LoaderResults.filterCurrentWorkspaceItems;
...
import com.demo.launcher.AllAppsList;
import com.demo.launcher.AppInfo;
import com.demo.launcher.FolderInfo;
import com.demo.launcher.IconCache;
import com.demo.launcher.InstallShortcutReceiver;
import com.demo.launcher.ItemInfo;
import com.demo.launcher.LauncherAppState;
import com.demo.launcher.LauncherAppWidgetInfo;
import com.demo.launcher.LauncherModel;
import com.demo.launcher.LauncherSettings;
import com.demo.launcher.ShortcutInfo;
import com.demo.launcher.Utilities;
import com.demo.launcher.compat.AppWidgetManagerCompat;
import com.demo.launcher.compat.LauncherAppsCompat;
import com.demo.launcher.compat.PackageInstallerCompat;
import com.demo.launcher.compat.UserManagerCompat;
import com.demo.launcher.config.FeatureFlags;
import com.demo.launcher.config.whitelist.WhiteList;
import com.demo.launcher.folder.Folder;
import com.demo.launcher.folder.FolderIconPreviewVerifier;
import com.demo.launcher.graphics.LauncherIcons;
import com.demo.launcher.logging.FileLog;
import com.demo.launcher.provider.ImportDataTask;
import com.demo.launcher.shortcuts.DeepShortcutManager;
import com.demo.launcher.shortcuts.ShortcutInfoCompat;
import com.demo.launcher.shortcuts.ShortcutKey;
import com.demo.launcher.util.ComponentKey;
import com.demo.launcher.util.LooperIdleLock;
import com.demo.launcher.util.MultiHashMap;
import com.demo.launcher.util.PackageManagerHelper;
import com.demo.launcher.util.Provider;
...
public class LoaderTask implements Runnable {
    ...
    private void verifyApplications() {
        ...
        ArrayList<AppInfo> allApp = mBgAllAppsList.data;
        synchronized (this) {
            ...
            for (AppInfo appInfo : allApp) {
              ...
              //  Log.i(TAG, "verifyApplications === [" + appInfo.componentName.getPackageName() + "]");
                LauncherActivityInfo app = appInfo.getInfo();
...
//                    String cpname = app.getComponentName().getPackageName();
////                    if(WhiteList.filterBlockPackage(cpname)){
////                        continue;
////                    }
//
//                    InstallShortcutReceiver.PendingInstallShortcutInfo pendingInstallShortcutInfo = new InstallShortcutReceiver.PendingInstallShortcutInfo(app, context);
