...
import com.demo.launcher.MainThreadExecutor;
import com.demo.launcher.PagedView;
...
/**
 * Helper class to handle results of {@link com.demo.launcher.model.LoaderTask}.
 */
public class LoaderResults {
    ...
    public void bindWorkspace() {
        Log.i(TAG , "bindWorkspace-----------111111111-----------");
        Runnable r;
        ...
        mUiExecutor.execute(new Runnable() {
            ...
            public void run() {
                Callbacks callbacks = mCallbacks.get();
                if (callbacks != null) {
                    Log.i(TAG, "--mUiExecutor--------callbacks--------------[screen id size ] [" + orderedScreenIds.size()+"]");
                    if(orderedScreenIds.size() > 0){
                        for(Long ll : orderedScreenIds){
                            Log.i(TAG, "--mUiExecutor--------callbacks-------------- ===== [" + ll +"]");
                        }
                    }else {
                        Log.i(TAG, "--mUiExecutor--------callbacks--------------[" + 0 +"]");
                    }
