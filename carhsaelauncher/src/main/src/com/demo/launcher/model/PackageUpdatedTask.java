...
import com.demo.launcher.LauncherModel.CallbackTask;
import com.demo.launcher.LauncherModel.Callbacks;
import com.demo.launcher.LauncherSettings.Favorites;
import com.demo.launcher.SessionCommitReceiver;
...
import com.demo.launcher.graphics.BitmapInfo;
...
import com.demo.launcher.util.FlagOp;
...
public class PackageUpdatedTask extends BaseModelUpdateTask {
            ...
            synchronized (dataModel) {
                for (ItemInfo info : dataModel.itemsIdMap) {
                    ...
                    if (info instanceof ShortcutInfo && mUser.equals(info.user)) {
                        ...
                        Log.i(TAG, "info is ==> ShortcutInfo");
                        ...
                        Log.i(TAG, "info is ==> LauncherAppWidgetInfo");
    ...
    private void updateToWorkSpace(Context context, LauncherAppState app, AllAppsList appsList) {
        ...
        ArrayList<AppInfo> allApp = appsList.data;
        synchronized (this) {
            for (AppInfo appInfo : allApp) {

                if(null == appInfo) continue;

                Log.i(TAG, "updateToWorkSpace======== "+ appInfo.getInfo().getComponentName().getPackageName());
                InstallShortcutReceiver.PendingInstallShortcutInfo pendingInstallShortcutInfo = new InstallShortcutReceiver.PendingInstallShortcutInfo(appInfo.getInfo(), context);
