...
package com.demo.launcher.logging;

import static com.demo.launcher.logging.LoggerUtils.newAction;
import static com.demo.launcher.logging.LoggerUtils.newCommandAction;
import static com.demo.launcher.logging.LoggerUtils.newContainerTarget;
import static com.demo.launcher.logging.LoggerUtils.newControlTarget;
import static com.demo.launcher.logging.LoggerUtils.newDropTarget;
import static com.demo.launcher.logging.LoggerUtils.newItemTarget;
import static com.demo.launcher.logging.LoggerUtils.newLauncherEvent;
import static com.demo.launcher.logging.LoggerUtils.newTarget;
import static com.demo.launcher.logging.LoggerUtils.newTouchAction;
...
import com.demo.launcher.userevent.nano.LauncherLogProto.LauncherEvent;
import com.demo.launcher.userevent.nano.LauncherLogProto.Target;
import com.demo.launcher.util.ComponentKey;
import com.demo.launcher.util.InstantAppResolver;
import com.demo.launcher.util.LogConfig;
...
public class UserEventDispatcher {
    ...
    * care about which screen moves to where. */
    ...
    public final void resetElapsedContainerMillis(String reason) {
        ...
        if (!IS_VERBOSE) {
            Log.d(TAG, "resetElapsedContainerMillis IS_VERBOSE111111111 reason=" + reason);
            return;
        }
