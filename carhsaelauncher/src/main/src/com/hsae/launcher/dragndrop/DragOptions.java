...
public class DragOptions {
    ...
    public String toString() {
        return "DragOptions{" +
                "isAccessibleDrag=" + isAccessibleDrag +
                ", systemDndStartPoint=" + systemDndStartPoint +
                ", preDragCondition=" + preDragCondition +
                ", intrinsicIconScaleFactor=" + intrinsicIconScaleFactor +
                '}';
    }
}
