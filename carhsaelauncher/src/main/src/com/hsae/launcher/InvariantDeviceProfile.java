...
public class InvariantDeviceProfile {
    ...
    public InvariantDeviceProfile(Context context) {
        ...
        Log.d(TAG , " device profile is  ==== " +closestProfile.name );
    ...
    ArrayList<InvariantDeviceProfile> findClosestDeviceProfiles(
        ...
        //Log.d(TAG , " device is  ==== width [" + width + "] , height ["+ height +"]" );

        ArrayList<InvariantDeviceProfile> pointsByNearness = points;
        Collections.sort(pointsByNearness, new Comparator<InvariantDeviceProfile>() {
            public int compare(InvariantDeviceProfile a, InvariantDeviceProfile b) {

               // Log.d(TAG , " device is  ====a hypot [" + dist(width, height, a.minWidthDps, a.minHeightDps) + "] , b hypot ["+ dist(width, height, b.minWidthDps, b.minHeightDps) +"]" );
