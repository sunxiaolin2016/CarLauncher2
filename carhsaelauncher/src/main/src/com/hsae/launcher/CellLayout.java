...
import com.hsae.launcher.LauncherSettings.Favorites;
import com.hsae.launcher.accessibility.DragAndDropAccessibilityDelegate;
import com.hsae.launcher.accessibility.FolderAccessibilityHelper;
import com.hsae.launcher.accessibility.WorkspaceAccessibilityHelper;
import com.hsae.launcher.anim.Interpolators;
import com.hsae.launcher.anim.PropertyListBuilder;
...
import com.hsae.launcher.util.CellAndSpan;
import com.hsae.launcher.util.GridOccupancy;
import com.hsae.launcher.util.ParcelableSparseArray;
...
import com.hsae.launcher.xingzuo.XinzuoImageView;
...
public class CellLayout extends ViewGroup {
    ...
    private ImageView mXzView = null;
    ...
    @Deprecated
    private int mCellLayoutMaxHeight = 1664;
    @Deprecated
    private int mCellLayoutMargin = 20;
    ...
    public CellLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mCellLayoutMaxHeight = getResources().getDimensionPixelSize(R.dimen.celllayout_max_height);
        mCellLayoutMargin = getResources().getDimensionPixelSize(R.dimen.celllayout_margin);
       ...
       // mDragOutlinePaint.setColor(Color.RED);
       ...
       // mImageView.setBackgroundResource(R.drawable.weather);
        addView(mImageView, -1, -2);
        mImageView.setVisibility(INVISIBLE);
        mImageView.setId(R.id.workspace_weather_container);
        // ======  end      hxq weather =====
       ...
       // mShortcutsAndWidgets.setBackgroundColor(Colo);
       // mShortcutsAndWidgets.setLayoutParams(param);
       // mShortcutsAndWidgets.setBackgroundColor(Color.RED);
     ...
     * @param resId
     */
    public void refreshTopPartImageBackGround(int resId){
        if(mImageView != null){
    ...
    /**hxq weather
     * set  the visibility of weather
     * @param visibility
     */
    public void enableTopPartImageBackGround(int visibility){
        if(mImageView != null){
     ...
     * @param resId
     */
    public void refreshXzImageBackGround(int resId){
        if(mXzView != null){
            mXzView.setImageResource(resId);
        }
    }
     ...
     * @param visibility
     */
    public void enableXzImageBackGround(int visibility){
        if(mXzView != null){
            mXzView.setVisibility(visibility);
        }
    }
    public void addXzImageView(){
        mXzView = new XinzuoImageView(this.getContext());
        addView(mXzView, -1, -2);
        mXzView.setVisibility(INVISIBLE);
        mXzView.setId(R.id.workspace_xz_container);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
      //  super.onMeasure(widthMeasureSpec, heightMeasureSpec);
        ...
        if (mImageView != null && mImageView.getVisibility() != GONE ) {
            ...
            final MarginLayoutParams lp = (MarginLayoutParams) mImageView.getLayoutParams();
            ...
            mImageView.measure(childWidthMeasureSpec, childHeightMeasureSpec);
        }

        if (mXzView != null && mXzView.getVisibility() != GONE){
            final MarginLayoutParams lp = (MarginLayoutParams) mXzView.getLayoutParams();
            final int childWidthMeasureSpec;
            if (lp.width == FrameLayout.LayoutParams.MATCH_PARENT) {
                final int width = Math.max(0, getMeasuredWidth()
                        - lp.leftMargin - lp.rightMargin);
            ...
            mXzView.measure(childWidthMeasureSpec, childHeightMeasureSpec);
        }
...
//        int childWidthSize = widthSize - 40- (getPaddingLeft() + getPaddingRight());
//        int childHeightSize = heightSize- 244 - (getPaddingTop() + getPaddingBottom());
    ...
    public void setPadding(int left, int top, int right, int bottom) {
        super.setPadding(30, 90, 30, 130);
       // Log.i(TAG ,  "setPadding _------ ******==== " + left + ", " + top + ", " +right + ", " + bottom);
    }

    @Override
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        // mImageView.layout(0,0, 1080,400);
        ...
        if (mXzView != null && mXzView.getVisibility() != GONE) {
            mXzView.layout(0, 900, mXzView.getMeasuredWidth(), mXzView.getMeasuredHeight() + 900);
        }
