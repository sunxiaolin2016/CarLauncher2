...
import static com.hsae.launcher.compat.AccessibilityManagerCompat.isAccessibilityEnabled;
import static com.hsae.launcher.compat.AccessibilityManagerCompat.isObservedEventType;
...
import com.hsae.launcher.pageindicators.PageIndicator;
import com.hsae.launcher.touch.OverScroll;
...
public abstract class PagedView<T extends View & PageIndicator> extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (DEBUG) Log.d(TAG, "measureChildren: " + myWidthSpec + ", " + myHeightSpec);
...
//                    final int childTop = verticalCenter - childHeight / 2;
    ...
    protected void dispatchPageCountChanged() {
        if (mPageIndicator != null) {
            mPageIndicator.setMarkersCount(getChildCount());

            Log.i(TAG, "======0000000000000============dispatchPageCountChanged== getChildCount() = [" + getChildCount()+ "]");
        }
