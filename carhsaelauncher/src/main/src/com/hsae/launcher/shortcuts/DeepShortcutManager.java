...
package com.hsae.launcher.shortcuts;
...
public class DeepShortcutManager {
    ...
    public static boolean supportsShortcuts(ItemInfo info) {
        boolean isItemPromise = info instanceof com.hsae.launcher.ShortcutInfo
                && ((com.hsae.launcher.ShortcutInfo) info).hasPromiseIconUi();
