...
import com.hsae.launcher.uioverrides.DisplayRotationListener;
...
public abstract class BaseDraggingActivity extends BaseActivity
    ...
    public static final String INTENT_EXTRA_IGNORE_LAUNCH_ANIMATION =
            "com.hsae.launcher.intent.extra.shortcut.INGORE_LAUNCH_ANIMATION";
    ...
    private int mThemeRes = R.style.AppThemeHsae;
    ...
    protected int getThemeRes(WallpaperColorInfo wallpaperColorInfo) {
        if (wallpaperColorInfo.isDark()) {
            ...
            return wallpaperColorInfo.supportsDarkText() ?
                    R.style.AppTheme_DarkText : R.style.AppThemeHsae;
        }
    }
